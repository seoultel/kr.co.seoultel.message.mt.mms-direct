...
//            }
    ...
    public static MimeBodyPart createTextMimeBodypart(String message) throws MessagingException {
    ...
    public static MimeBodyPart createImageMimeBodypart(String imageId, byte[] bytes) throws MessagingException {
